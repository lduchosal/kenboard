...
# Import-for-side-effect : attache les commandes burndown au groupe `cli`
# (#808). En fin de module — cli_burndown importe `cli` d'ici, un import en
# tête serait circulaire.
from dashboard import cli_burndown  # noqa: E402, F401
